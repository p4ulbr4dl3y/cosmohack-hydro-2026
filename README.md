...
- **Согласование учета постоянного русла (Adaptive Channel Normalization):** приведение $water\_peak$ и $water\_pre$ на парах Группы Б к конвенции организаторов (вычитание постоянного русла, идентично слою $flood$) поднимает $Q_{water\_peak}$ с 0.4612 до **0.5682**, $Q_{water\_pre}$ с 0.3948 до **0.5702**, а итоговый Composite Score — до **0.6238**.
