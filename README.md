...
|---|---|---|
| **Пиковое потребление RAM** | **< 1.4 ГБ** (оценка) | Конструктивно оптимизировано блочным чтением через `rasterio.windows.Window`; *бенчмарк в репозитории не зафиксирован — значение не верифицировано* |
| **Время обработки сцены** | **~2.8 сек / пара** (оценка) | Обычный многоядерный CPU (Apple Silicon M-серии / Intel Core i7 / AMD Ryzen); *бенчмарк в репозитории не зафиксирован — значение не верифицировано* |
...
| **Время холодного старта API** | **< 1.2 сек** (оценка) | Легковесный ASGI uvicorn + FastAPI; *бенчмарк в репозитории не зафиксирован* |
