...
### 7.4. Перспективные направления масштабирования сервиса (Roadmap 2026-2027)
...
> - в репозитории **полностью автономно и офлайн** работают: веб-сервис, дашборд, REST API, расчет официального Score (`evaluate`), аналитические справки (`report`) и готовые маски предсказаний (`predictions/`);
