...
export const Methodology: React.FC = () => {
  ...
  const pipelineSteps = [
    ...
    },
    {
      ...
      desc: 'MNDWI > 0,1, NDWI > 0,15, NDVI ≤ 0,2, AWEIsh > 0 — там, где оптика пригодна.',
    },
    {
      num: '03',
      title: 'Гидрологические фильтры',
      desc: 'slope ≤ 5°, HAND ≤ 25 м, GSW occurrence ≥ 80%, минимальная картируемая единица 25 пикселей.',
    },
    {
      num: '04',
