...
export const Landing: React.FC = () => {
  ...
  // Автопереключение слайдшоу каждые 4.5 секунды, если пользователь не навёл курсор
  useEffect(() => {
    ...
    <div className="min-h-screen bg-[#FAFBFC] text-text-primary flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 w-full space-y-12 sm:space-y-16">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          {/* Правая колонка главной секции: интерактивная карточка слайдшоу локаций */}
          <div className="lg:col-span-6">
            ...
            >
              {/* Реальная карта Leaflet со всеми реальными слоями */}
              ...
              {/* Бейдж локации (верхний левый угол) */}
              ...
              {/* Плавающий бейдж реальных KPI (верхний правый угол) */}
              ...
              {/* Кнопка быстрого перехода к дашборду (при наведении) */}
              {currentPair && (
                <button
              ...
              {/* Нижняя панель: полоса легенды классов воды + интерактивные точки-индикаторы слайдов */}
