...
export const ENDPOINTS: EndpointDef[] = [
      ...
      [
        {
          ...
          date_pre_opt: '2019-06-14',
          date_peak_opt: '2019-07-24',
          aoi_km2: 1649.17,
          flood_ha: 2847.3,
          has_optical: true,
        },
    ...
    responseExample: JSON.stringify(
      {
        ...
        layers: {
          flood_mask: '/api/v1/layers/flood_2019_07_amur__blagoveshchensk/flood',
          water_peak: '/api/v1/layers/flood_2019_07_amur__blagoveshchensk/water_peak',
          water_pre: '/api/v1/layers/flood_2019_07_amur__blagoveshchensk/water_pre',
        },
      },
      null,
      2
    ...
    responseExample: JSON.stringify(
      {
        pair_id: 'flood_2019_07_amur__blagoveshchensk',
        rows: [
          { metric: 'flood_ha', label: 'Новое затопление', pred: 2847.3, reference: 2847.3, diff_pct: 0.0 },
          { metric: 'water_peak_ha', label: 'Водное зеркало (пик)', pred: 9106.9, reference: 9106.9, diff_pct: 0.0 },
          { metric: 'water_pre_ha', label: 'Водное зеркало (до)', pred: 3227.8, reference: 3227.8, diff_pct: 0.0 },
        ],
      },
      null,
      2
  ...
  },
  {
    ...
    responseExample: JSON.stringify(
      {
        models: [
          { name: 'Otsu VV Baseline', f1_flood: 0.742, iou_flood: 0.591 },
          { name: 'SAR + MSI Consensus', f1_flood: 0.884, iou_flood: 0.793 },
          { name: 'Full Pipeline + Postprocess', f1_flood: 0.912, iou_flood: 0.838 },
        ],
      },
      null,
      2
    ...
    responseExample: JSON.stringify(
      {
        ...
        features: [
          {
            type: 'Feature',
            properties: { class: 'flood', area_ha: 2847.3 },
    ...
    responseExample: JSON.stringify(
      {
        ...
        features: [
          {
            type: 'Feature',
            properties: { layer: 'flood', area_ha: 2847.3 },
            geometry: { type: 'Polygon', coordinates: [] },
          },
        ],
      },
