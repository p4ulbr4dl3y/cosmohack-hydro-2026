...
export const ReportDocument: React.FC<ReportDocumentProps> = ({
  ...
  const landcoverItems = [
    { class_name: 'Лес (древесный покров)', area_ha: 1234.5, pct: 43.4 },
    { class_name: 'Сельхозугодья / Пашни', area_ha: 876.2, pct: 30.8 },
    { class_name: 'Луга / Травянистый покров', area_ha: 481.7, pct: 17.0 },
    { class_name: 'Застройка / Населенные пункты', area_ha: 186.7, pct: 6.6 },
    { class_name: 'Открытые грунты / Пески', area_ha: 92.3, pct: 3.2 },
    { class_name: 'Водные объекты', area_ha: 61.2, pct: 2.2 },
  ];

  const currentDateFormatted = '21.09.2026 14:32 UTC';
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="border border-[#EAECF0] rounded-xl p-4 bg-white space-y-3 shadow-2xs">
            ...
            <div className="grid grid-cols-2 gap-y-2 text-xs">
              ...
              <span className="font-mono text-text-primary text-right font-medium">
                {report.date_pre_sar || '13.06.2019'} → {report.date_peak_sar || '25.07.2019'}
              </span>
              <span className="text-text-secondary">Орбита</span>
              <span className="font-mono text-text-primary text-right">ASCENDING</span>
              <span className="text-text-secondary">Поляризации</span>
              <span className="font-mono text-text-primary text-right">VV / VH</span>
              <span className="text-text-secondary">Δt (разрыв)</span>
              <span className="font-mono text-text-primary text-right">2 суток</span>
            </div>
          </div>
          ...
          <div className="border border-[#EAECF0] rounded-xl p-4 bg-white space-y-3 shadow-2xs">
            ...
            <div className="grid grid-cols-2 gap-y-2 text-xs">
              <span className="text-text-secondary">Дата наблюдения</span>
              <span className="font-mono text-text-primary text-right font-medium">13.07.2019</span>
              <span className="text-text-secondary">Облачность</span>
              <span className="font-mono text-text-primary text-right">18%</span>
